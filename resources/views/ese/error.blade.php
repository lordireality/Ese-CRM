...
<html>
	...
	<body>
        <header>
            <div class="menu">
                <a href="/" class="logo"><h1 style="display: inline;">EseCRM</h1><img style="height:2em; width:2em; vertical-align:baseline;" src="{{ asset('/ese/content/images/eseapplogotransparent.png') }}"/></a>
            </div>
        </header>
