...
<html>
	<head>
        ...
        <link rel="stylesheet" data-name="vs/editor/editor.main" href="{{ asset('/ese/content/monaco-editor/min/vs/editor/editor.main.css') }}">
        <script src="{{ asset('/ese/content/js/popup.js') }}"></script>
        <script src="{{ asset('/ese/content/js/EseHTTP.js') }}"></script>
        <script src="{{ asset('/ese/content/js/logout.js') }}"></script>
        ...
        <header>
            <div class="menu">
                ...
                <ul>
                   ...
                   <!-- <li><a class="button2" href="{{route('layoutTest')}}">Мессенджер[TODO]</a></li> route('Messages')-->
                   <!-- <li><a class="button2" href="{{route('layoutTest')}}">Контрагенты[TODO]</a></li> route('Documents')-->
                   <!-- <li><a class="button2" href="{{route('layoutTest')}}">Файлы[TODO]</a></li> route('Processes')-->
